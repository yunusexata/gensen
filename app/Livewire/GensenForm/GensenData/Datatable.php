    ...
    public function saveEditedRow()
    {
        try {
            ...
            $validatedData = [
                ...
                'tanggal_lengkap' => Carbon::parse($this->editingData['tanggal_lengkap'])->format('Y-m-d'),
                'tanggal_verified' => Carbon::parse($this->editingData['tanggal_verified'])->format('Y-m-d'),
                'no_input_jepang' => $this->editingData['no_input_jepang'],
                'tanggal_cair' => Carbon::parse($this->editingData['tanggal_cair'])->format('Y-m-d'),
                ...
                'tanggal_kepulangan' => Carbon::parse($this->editingData['tanggal_kepulangan'])->format('Y-m-d'),
                // REK PENERIMA
