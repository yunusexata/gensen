...
class Datatable extends Component
{
    ...
    public function saveEditedRow()
    {
        try {
            ...
            $validatedData = [
                'status' => $this->editidData['status'],
                'nama_lengkap' => $this->editidData['nama_lengkap'],
                'tanggal_lahir' => $this->editidData['tanggal_lahir'],
                'email' => $this->editidData['email'],
                'tanggal_lengkap' => Carbon::parse($this->editidData['tanggal_lengkap'])->format('Y-m-d'),
                ...
                'nama_bank_penerima' => $this->editidData['nama_bank_penerima'],
                'nama_penerima' => $this->editidData['nama_penerima'],
                'hubungan_penerima' => $this->editidData['hubungan_penerima'],
                // 'status' => $this->editidData['status'],
                'tahun_gensen' => $this->editidData['tahun_gensen'],
                'tahun_transfer' => $this->editidData['tahun_transfer'],
                'nama_instagram' => $this->editidData['nama_instagram'],
                'nama_tiktok' => $this->editidData['nama_tiktok'],
                'nomor_whatsapp' => $this->editidData['nomor_whatsapp'],
                'nomor_whatsapp_darurat' => $this->editidData['nomor_whatsapp_darurat'],
                'alamat_jepang' => $this->editidData['alamat_jepang'],
                'kode_pos_jepang' => $this->editidData['kode_pos_jepang'],
                'nama_lpk' => $this->editidData['nama_lpk'],
                'keterangan_mondai' => $this->editidData['keterangan_mondai'],
            ];
