...
class IchijikinService
{
    ...
    public function handleCropDocument($model)
    {
        ...
        // Crop Kokumin
        $coord = ['x' => 665, 'y' => 55, 'width' => 186, 'height' => 58];
        $this->cropImage($path, $coord, $folder, 'kokumin');

        // Crop Payment
        $coord = ['x' => 665, 'y' => 406, 'width' => 203, 'height' => 58];
        $this->cropImage($path, $coord, $folder, 'nenkin_100');

        // Crop Income
        $coord = ['x' => 665, 'y' => 483, 'width' => 203, 'height' => 58];
        $this->cropImage($path, $coord, $folder, 'nenkin_20');

        // Crop Net
        $coord = ['x' => 665, 'y' => 581, 'width' => 203, 'height' => 58];
        $this->cropImage($path, $coord, $folder, 'nenkin_80');

        // Crop Number
        $coord = ['x' => 717, 'y' => 1042, 'width' => 195, 'height' => 58];
        ...
        // Crop Lama Kerja
        $coord = ['x' => 700, 'y' => 790, 'width' => 150, 'height' => 90];
