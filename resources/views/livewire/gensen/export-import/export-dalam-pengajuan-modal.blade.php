    ...
    <div class="modal" id="exportDalamPengajuanModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        wire:ignore.self>
            ...
            <div class="modal-content" style="overflow: scroll">
                ...
                <form wire:submit.prevent="storeImportBulkStatus">
                        ...
                        <div class="row">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="imported-bulk-status" data-bs-toggle="tab" data-bs-target="#imported-bulk-status-pane" type="button" role="tab" aria-controls="imported-bulk-status-pane" aria-selected="true">Exported</button>
                                </li>
                                <li class="nav-item" role="presentation">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="closeExportDalamPengajuanModal">Tutup</button>
    ...
    @push('js')
        ...
        document.addEventListener('livewire:init', () => {
                Livewire.on('onSuccessExportDalamPengajuan', () => {
                $('#exportDalamPengajuanModal').modal('hide');
