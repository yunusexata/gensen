<div>
    @if ($isCanDelete)
        <div class="row mb-3">
            <div class="col-auto">
                <button type="button" class="btn btn-danger btn-sm d-flex align-items-center gap-2" wire:click="showForceDeleteFilterDialog">
                    <span class="material-symbols-outlined text-lg">delete_sweep</span>
                    <span>Hapus Permanent Hasil Filter</span>
                </button>
            </div>
        </div>
    @endif
