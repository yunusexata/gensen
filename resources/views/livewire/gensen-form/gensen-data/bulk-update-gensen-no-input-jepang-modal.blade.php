    ...
    <div class="modal" id="bulkUpdateGensenNoInputJepangModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        wire:ignore.self>
        <div class="modal-dialog modal-fullscreen custom-zoom" style="overflow: scroll">
            <div class="modal-content" style="overflow: scroll">
                <div class="modal-header">
                    <h5 class="modal-title" id="bulkUpdateGensenNoInputJepangModalLabel">Import List Data No Input Jepang</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="closebulkUpdateGensenNoInputJepangModal"></button>
                </div>
                <form wire:submit.prevent="storeImportBulkStatus">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="closebulkUpdateGensenNoInputJepangModal">Tutup</button>
