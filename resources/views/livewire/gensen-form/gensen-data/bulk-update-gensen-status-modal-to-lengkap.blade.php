    ...
    <div class="modal" id="bulkUpdateGensenStatusModalToLengkap" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        wire:ignore.self>
        <div class="modal-dialog modal-fullscreen custom-zoom" style="overflow: scroll">
            <div class="modal-content" style="overflow: scroll">
                <div class="modal-header">
                    <h5 class="modal-title" id="bulkUpdateGensenStatusModalToLengkapLabel">Import List Data Lengkap</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" wire:click="closebulkUpdateGensenStatusModalToLengkap"></button>
                </div>
                <form wire:submit.prevent="storeImportBulkStatus">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" wire:click="closebulkUpdateGensenStatusModalToLengkap">Tutup</button>
