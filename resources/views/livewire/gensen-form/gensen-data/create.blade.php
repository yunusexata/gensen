                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div class="flex flex-col gap-2">
                            <label class="font-label text-xs font-medium text-on-surface-variant" for="nama_lengkap">Nama lengkap</label>
                        ...
                        <div class="flex flex-col gap-2">
                            <label class="font-label text-xs font-medium text-on-surface-variant" for="nama_instagram">Nama Instagram</label>
                            <input class="bg-surface-container-low border-none rounded-lg p-3 font-body text-on-surface form-input-focus placeholder:text-outline-variant/50 w-full" id="nama_instagram" wire:model="nama_instagram" name="nama_instagram" type="text" placeholder="Nama Facebook"/>
                        </div>
                        <div class="flex flex-col gap-2">
                            <label class="font-label text-xs font-medium text-on-surface-variant" for="nama_tiktok">Nama Tiktok</label>
                            <input class="bg-surface-container-low border-none rounded-lg p-3 font-body text-on-surface form-input-focus placeholder:text-outline-variant/50 w-full" id="nama_tiktok" wire:model="nama_tiktok" name="nama_tiktok" type="text" placeholder="Nama Facebook"/>
                        </div>
                        <div class="flex flex-col gap-2">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input class="bg-surface-container-low border-none rounded-lg p-3 font-body text-on-surface form-input-focus placeholder:text-outline-variant/50 w-full" id="nomor_whatsapp_darurat" wire:model="nomor_whatsapp_darurat" name="nomor_whatsapp_darurat" type="text" placeholder="Nama Facebook"/>
                        </div>
                        <div class="flex flex-col gap-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                        <div class="flex flex-col gap-2">
                            ...
                            <select
                                ...
                                class="bg-surface-container-low border-none rounded-lg p-3 font-body text-on-surface form-input-focus w-full"
                            >
            ...
            <div class="flex-column" data-kt-stepper-element="content" wire:ignore.self>
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="kertas_gensen">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        </div>
                            ...
                            @if ($kertas_gensen_old && $kertas_gensen_old['groups']->isNotEmpty())
                                @foreach ($kertas_gensen_old['groups']->first()['files'] as $item)
                                    ...
                                    @elseif($item['isPdf'] && !$item['isImage'])
                                        <embed src="{{ $item['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                            {{-- <iframe
                        ...
                        @foreach ($rekap_pengiriman_uang as $rekap_index => $rekap)
                            ...
                            >
                                <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                                    ...
                                    @if ($rekap['type'])
                                        <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="rekap_pengiriman_uang.{{$rekap_index}}.file">
                                            <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                            <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                            <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                                        </label>
                        ...
                        @foreach ($rekap_pengiriman_uang_old['groups'] as $item)
                            ...
                            @foreach ($item['files'] as $rekap)
                                ...
                                @elseif($rekap['isPdf'] && !$rekap['isImage'])
                                    <embed src="{{ $rekap['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="kartu_keluarga">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="zairyou_card_front">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        ...
                        <div class="upload_gallery d-flex flex-wrap justify-content-center gap-3 mb-0">
                            ...
                            @if ($zairyou_card_front_old)
                                ...
                                @elseif($zairyou_card_front_old['isPdf'] && !$zairyou_card_front_old['isImage'])
                                    <embed src="{{ $zairyou_card_front_old['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="zairyou_card_back">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        ...
                        <div class="upload_gallery d-flex flex-wrap justify-content-center gap-3 mb-0">
                            ...
                            @if ($zairyou_card_back_old)
                                ...
                                @elseif($zairyou_card_back_old['isPdf'] && !$zairyou_card_back_old['isImage'])
                                    <embed src="{{ $zairyou_card_back_old['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="my_number_front">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        ...
                        <div class="upload_gallery d-flex flex-wrap justify-content-center gap-3 mb-0">
                            ...
                            @if ($my_number_front_old)
                                ...
                                @elseif($my_number_front_old['isPdf'] && !$my_number_front_old['isImage'])
                                    <embed src="{{ $my_number_front_old['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="my_number_back">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        ...
                        <div class="upload_gallery d-flex flex-wrap justify-content-center gap-3 mb-0">
                            ...
                            @if ($my_number_back_old)
                                ...
                                @elseif($my_number_back_old['isPdf'] && !$my_number_back_old['isImage'])
                                    <embed src="{{ $my_number_back_old['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
                ...
                <section class="mt-5">
                    ...
                    >
                        ...
                        <div class="border-2 border-dashed border-outline-variant/30 rounded-xl p-0 text-center bg-surface-container-low/30 hover:bg-surface-container-low transition-colors duration-300">
                            ...
                            accept="image/jpeg, image/png, application/pdf"
                            class="position-absolute invisible"/>
                            <label class="cursor-pointer flex flex-col items-center gap-3 p-2" for="rekening_indonesia">
                                <span class="material-symbols-outlined text-5xl text-primary-container my-0" data-icon="description">description</span>
                                <p class="font-body text-on-surface-variant my-0">Drag and drop file kamu disini, atau <span class="text-primary font-semibold">CARI FILE</span></p>
                                <p class="text-xs text-outline font-medium my-0">Format: PDF (Max 10MB)</p>
                            </label>
                        ...
                        <div class="upload_gallery d-flex flex-wrap justify-content-center gap-3 mb-0">
                            ...
                            @if ($rekening_indonesia_old)
                                ...
                                @elseif($rekening_indonesia_old['isPdf'] && !$rekening_indonesia_old['isImage'])
                                    <embed src="{{ $rekening_indonesia_old['url'] }}" type="application/pdf" width="100%" style="height: 60vh;" style="min-height: 400px;" class="mb-2">
                                        {{-- <iframe
