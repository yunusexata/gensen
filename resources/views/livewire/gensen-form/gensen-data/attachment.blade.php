                    ...
                    <main class="w-full max-w-container-max mx-auto flex flex-row border overflow-hidden p-0">
                        ...
                        <section class="w-[35%] p-5 flex flex-col h-full bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm">
                            ...
                            <div class="space-y-4">
                                ...
                                @if ($remittance_extraction && (!$remittance_extraction->aiJobs ||  ! $remittance_extraction->aiJobs->contains('status', JobStatus::PENDING)))
                                    ...
                                    @endforeach
                                @elseif($remittance_extraction->aiJobs && $remittance_extraction->aiJobs->contains('status', JobStatus::PENDING))
                                    <div class="">
