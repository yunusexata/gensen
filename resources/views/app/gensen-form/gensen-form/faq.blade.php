                ...
                <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div x-data="{ openItem: 1 }" class="gap-y- gird-cols-1 grid gap-x-8 xl:grid-cols-2">
                        <div class="space-y-3">
                            ...
                            <!-- item 8 -->
                            <div x-data="{ id: 8 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 8, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 8 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 9 -->
                            <div x-data="{ id: 9 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 9, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 9 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 10 -->
                            <div x-data="{ id: 10 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 10, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 10 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 11 -->
                            <div x-data="{ id: 11 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 11, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 11 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 12 -->
                            <div x-data="{ id: 12 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 12, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 12 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 13 -->
                            <div x-data="{ id: 13 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 13, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 13 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 14 -->
                            <div x-data="{ id: 14 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 14, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 14 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 15 -->
                            <div x-data="{ id: 15 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 15, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 15 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 16 -->
                            <div x-data="{ id: 16 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 16, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 16 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 17 -->
                            <div x-data="{ id: 17 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 17, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 17 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
                            ...
                            <!-- item 18 -->
                            <div x-data="{ id: 18 }" :class="{ 'bg-brand-50 dark:bg-brand-100': openItem === 18, 'bg-gray-100 dark:bg-white/[0.03]': openItem !== 18 }" class="overflow-hidden rounded-xl bg-gray-100 dark:bg-white/[0.03]">
